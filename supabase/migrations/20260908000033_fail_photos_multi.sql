-- „Nem sikerült” jelentéshez több fotó is csatolható.

alter table public.worker_tasks add column if not exists fail_photo_paths text[] not null default '{}';
update public.worker_tasks set fail_photo_paths = array[fail_photo_path]
where fail_photo_path is not null and fail_photo_paths = '{}';
